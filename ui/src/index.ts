  ...
  ucRoutes: [
    {
      ...
      route: {
        ...
        children: [
          {
            path: 'query',
            name: 'ArticleIdManagementQueryUC',
            component: HomeView,
            props: { mode: 'query' },
            meta: {
              title: '编号查询',
          ...
          {
            path: 'create',
            name: 'ArticleIdManagementCreateUC',
            component: HomeView,
            props: { mode: 'create' },
            meta: {
              title: '编号创建',
          ...
          {
            path: 'update',
            name: 'ArticleIdManagementUpdateUC',
            component: HomeView,
            props: { mode: 'update' },
            meta: {
              title: '编号修改',
          ...
          {
            path: 'manage',
            name: 'ArticleIdManagementManageUC',
            component: HomeView,
            props: { mode: 'manage' },
            meta: {
              title: '规则管理',
          ...
          {
            path: 'logs',
            name: 'ArticleIdManagementLogsUC',
            component: HomeView,
            props: { mode: 'logs' },
            meta: {
              title: '操作日志',
